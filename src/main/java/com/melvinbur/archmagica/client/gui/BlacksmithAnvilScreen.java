...
import com.melvinbur.archmagica.common.container.BlacksmithAnvilContainer;
...
public class BlacksmithAnvilScreen extends ContainerScreen<BlacksmithAnvilContainer> implements IRecipeShownListener {
    private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES
            = new ResourceLocation(ArchMagica.MOD_ID, "textures/gui/blacksmith_anvil.png");
    ...
    public BlacksmithAnvilScreen(BlacksmithAnvilContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void init() {
        ...
        // Recipe Button Disabled for the time being
        this.addButton(new ImageButton(this.guiLeft + 135, this.guiTop + 76, 20, 18,
                0, 0, 19, RECIPE_BUTTON_TEXTURE, (button) -> {
            this.recipeBookGui.initSearchBar(this.widthTooNarrow);
            this.recipeBookGui.toggleVisibility();
            this.guiLeft = this.recipeBookGui.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
            ((ImageButton)button).setPosition(this.guiLeft + 135, this.guiTop + 76);
        }));
        this.titleX = 29;
    }
