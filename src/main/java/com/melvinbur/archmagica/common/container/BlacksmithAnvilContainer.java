...
public class BlacksmithAnvilContainer extends RecipeBookContainer<CraftingInventory> {
    ...
    public BlacksmithAnvilContainer(int id, PlayerInventory playerInventory) {
        this(id,  playerInventory, IWorldPosCallable.DUMMY);
    }

    public BlacksmithAnvilContainer(int id, PlayerInventory playerInventory, IWorldPosCallable pos) {
        super(ContainerTypesInit.BLACKSMITH_ANVIL.get(), id);
